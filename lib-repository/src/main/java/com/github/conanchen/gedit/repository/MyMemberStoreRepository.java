 ...
 */
@Singleton
public class MyMemberStoreRepository {
    private final static String TAG = MyMemberStoreRepository.class.getSimpleName();
    ...
    @Inject
    public MyMemberStoreRepository(RoomFascade roomFascade, GrpcFascade grpcFascade) {
