...
public class MyWorkinStore {
    ...
    public MyWorkinStore() {
    }

    private MyWorkinStore(@NonNull String storeUuid, String storeName, String storeLogo, Double lat, Double lon, long created, long lastUpdated) {
