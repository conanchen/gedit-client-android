...
public class CanConsumptionPointsAdapter extends PagedListAdapter<Store, CanConsumptionPointsAdapter.ViewHolder> {

    protected CanConsumptionPointsAdapter() {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CanConsumptionPointsAdapter.ViewHolder(view);
    }
